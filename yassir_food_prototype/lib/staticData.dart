...
class StaticData {
  ...
  static List<Category> menu = [
    Category(
        banner:
            "https://glasrestaurant.ie/assets/img/Glas_restaurant_food_01.jpg?v2",
        food: food,
        nameCat: "Desserts",
        idCat: "1"),
    Category(
        banner:
            "http://www.gorwelion.co.uk/wp-content/uploads/2015/07/fine-dining-01.jpg",
        food: food,
        nameCat: "Entrées chaudes",
        idCat: "2"),
    Category(
        banner:
            "https://st4.depositphotos.com/1959135/22184/i/1600/depositphotos_221844198-stock-photo-grilled-chicken-legs-tomato-sauce.jpg",
        food: food,
        nameCat: "Entrées froids",
        idCat: "3"),
    Category(
        banner:
    ...
    Category(
        ...
        idCat: "5"),
    Category(
        banner: "https://media.timeout.com/images/105326979/750/422/image.jpg",
        food: food,
        nameCat: "Pâtes",
        idCat: "6"),
    Category(
  ...
  static List<Restaurant> restaurants = [
    Restaurant(
        adrs: "Staouali, Algérie",
        banner:
            "https://st4.depositphotos.com/1959135/22184/i/1600/depositphotos_221844198-stock-photo-grilled-chicken-legs-tomato-sauce.jpg",
        idRestaurant: "1",
        nameRestaurant: "La Famillie",
        rating: 4.5,
        isOpen: true,
        close_at: "22:00",
        delivers_in: "40-45 Mins",
        menu: menu),
    Restaurant(
        adrs: "Bab Ezzouar, Algérie",
        banner:
            "http://www.gorwelion.co.uk/wp-content/uploads/2015/07/fine-dining-01.jpg",
        idRestaurant: "2",
        nameRestaurant: "Savanah",
        rating: 5.0,
        isOpen: true,
        close_at: "22:00",
        delivers_in: "40-45 Mins",
        menu: menu),
    Restaurant(
        adrs: "El Biar, Algérie",
        banner:
            "https://cdn.pixabay.com/photo/2017/12/09/08/18/pizza-3007395_960_720.jpg",
        idRestaurant: "3",
        nameRestaurant: "Casa Alger",
        rating: 3.7,
        isOpen: false,
        close_at: "22:00",
        delivers_in: "40-45 Mins",
    ...
    Restaurant(
        ...
        menu: menu),
    Restaurant(
        adrs: "Alger Centre, Algérie",
        banner:
            "https://cdn.pixabay.com/photo/2014/05/18/11/25/pizza-346985_960_720.jpg",
        idRestaurant: "6",
        nameRestaurant: "Savanah",
        rating: 1.8,
        isOpen: true,
        ...
        menu: menu),
    Restaurant(
        adrs: "Boulevard du 11 Decembre 1960, El Biar, Algérie",
        banner:
            "https://cdn.pixabay.com/photo/2017/12/09/08/18/pizza-3007395_960_720.jpg",
        idRestaurant: "7",
        nameRestaurant: "Pizza Time val d'hydra",
        rating: 1.8,
        isOpen: true,
        close_at: "22:00",
        delivers_in: "40-45 Mins",
  ...
  //-------- Filters map
  static initFilters() => filters = {for (var cat in menu) cat.idCat: false};
  static Map<String, bool> filters = {for (var cat in menu) cat.idCat: false};
  ...
  static List<Address> addresses = [
    Address(adr: "Home",name: "El Biar, Alger"),
    Address(adr: "Work",name: "Staoueli, Alger"),
    Address(adr: "ADR1",name: "Bab Ezzouar, Alger"),
  ];
  //------- Account Info
